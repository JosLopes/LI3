...
\begin{center}
    \begin{tabular}{|l|c|c|c|c|}
        ...
        \hline
        CPU & Intel i3-7100 & Ryzen 7 5800H & M1 & Mediatek Helio P22T \\
        \hline
        ...
        3.9 GHz & 4.4 GHz & ? & 2.3 GHz \\
        \hline
        Memória & DDR4 2400 MT/s & DDR4 3200 MT/s & ? & LPDDR4X 4266 MT/s \\
        \hline
        Linux & 6.6.11 (chroot) & 5.15.91 & ? & 4.9.190 \\
        \hline
        Compilador & GCC 12.2.0 & GCC 9.4.0 & ? & Clang 17.0.6 \\
        \hline
    \end{tabular}
\end{center}
