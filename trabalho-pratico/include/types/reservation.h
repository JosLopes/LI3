 ...
 * @param hotel_id           Id of the reservation's hotel, of type `char*`.
 ...
 * @param id                 Id of a given reservation, of type `int`.
 * @param hotel_stars        Stars assigned the reservation's hotel, of type `int`.
 * @param begin_date         Beginning date of a given reservation, of type `int`.
 * @param end_date           End date of a given reservation, of type `int`.
 ...
 *        zero (received as an int)/ no_input (no value received)/ f/ false
 ...
 *
 * @param reservation Reservation of type `reservation_t*`.
 * @param hotel_id    Hotel id of a given reservation, of type `char*`.
 */
 ...
 *
 * @param reservation Reservation of type `reservation_t*`.
 * @param begin_date  Begin date of a given reservation, of type `int`.
 */
 ...
 * @param reservation Reservation of type `reservation_t*`.
 * @return The reservation's hotel_id, of type `const char*`. 
 */
 ...
 * @param reservation Reservation of type `reservation_t*`.
 * @return The reservation's begin_date, of type `int`. 
 */
 ...
 * @param reservation Reservation of type `reservation_t*`.
 * @return The reservation's end_date, of type `int`. 
 */
