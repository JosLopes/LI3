 ...
 * @param instance   Query instance to run.
 ...
 * @return The method called for executing a query data.
 */
query_type_execute_callback query_type_get_execute_callback(query_type_t *type);

/**
 * @brief   Frees memory in a ::query_type_t.
 * @details Statistical data won't be freed. You're supposed to do that yourself. This way, you
 *          can free it as you're running queries, and not accumulate data until the end of query
 *          execution. This is automatically handled in query_dispatcher.h.
 *
