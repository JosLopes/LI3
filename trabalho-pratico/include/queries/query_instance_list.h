 ...
 *   and finally, one for Erin. A tip to index a pointer to multiple ::query_instance_t is to
 *   increment it by ::query_instance_sizeof bytes:
 *
 *   ```c
 *   query_instance_t *instance_i =
 *       (query_instance_t *) ((uint8_t *) instances + i * query_instance_sizeof());
 *   ```
 */
