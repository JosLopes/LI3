 ...
 *     "2024/01/15 23:59:59",  // Due date for this project (we're screwed)
 *     "2024/01/15 23:59:59 ", // Too many spaces
 * };
 *
 * for (int i = 0; i < 2; ++i) {
 ...
 * @return Date in the @p date_and_time.
 */
 ...
 * @param date          Value of the date to be placed in @p date_and_time.
 */
 ...
 * @param date_and_time Timed date to be modified.
 * @param time          Value of the time to be placed in @p date_and_time.
 */
