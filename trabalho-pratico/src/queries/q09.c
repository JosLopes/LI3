...
/**
 * @brief Frees data generated by ::__q09_parse_arguments.
 * @param argument_data Data generated by ::__q09_parse_arguments.
 */
void __q09_free_query_instance_argument_data(void *argument_data) {
    free(argument_data);
}
...
query_type_t *q09_create(void) {
    return query_type_create(__q09_parse_arguments,
                             __q09_free_query_instance_argument_data,
                             NULL,
                             NULL,
                             __q09_execute);
}
