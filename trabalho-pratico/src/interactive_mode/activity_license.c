...
/**
 * @file  activity_license.c
 * @brief Implementation of methods in include/interactive_mode/activity_license.h
 *
 * ### Examples
...
void activity_license_run(void) {
    ...
    activity_paging_run(sizeof(license) / sizeof(const char *const), license, 0, "LICENSE");
}
